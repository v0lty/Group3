    ...
    return (
        <div className="bg-white shadow p-2 mb-4">
            ...
            <ListGroup as="ul" className="border-0">
                {posts.map(post =>
                    <ListGroup.Item key={post.Id} as="li" className="sidebar-item d-flex justify-content-between align-items-start border-0 border-top" onClick={() => onPostClick(post.Subject.Id)}>
